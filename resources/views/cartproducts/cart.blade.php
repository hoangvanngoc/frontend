...
@section('content')
    ...
    <table id="cart" class="table table-hover table-condensed">
        ...
        <tfoot>
        <tr class="visible-xs">
            <td class="text-center"><strong>Total {{number_format($total) }} VND</strong></td>
        </tr>
        <tr>
            <td><a href="{{ url('/') }}" class="btn btn-warning"><i class="fa fa-angle-left"></i> Continue Shopping</a></td>
            <td colspan="2" class="hidden-xs"></td>
            <td class="hidden-xs text-center"><strong>Total {{ number_format($total) }} VND</strong></td>
            <td><a href="{{ route('checkout.get') }}" class="btn btn-warning"><i class="fa fa-angle-right"></i> Continue Buy</a></td>
        </tr>
        </tfoot>
    </table>
