        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    ...
                    @else
                    <a href="{{ route('category.product',['slug'=>$categoryChildrens->slug, 'id'=>$categoryChildrens->id]) }}">
            ...
            <div id="sportswear_{{ $category->id }}" class="panel-collapse collapse">
                <div class="panel-body">
                    <ul>
                        @foreach ($category->CategoryChildren as $categoryChildrens)
                        <li>
                            <a href="{{ route('category.product',
                            ['slug'=>$categoryChildrens->slug, 'id'=>$categoryChildrens->id]) }}">
                                {{ $categoryChildrens->name }} </a>
                        </li>
                        @endforeach
                    </ul>
                </div>
